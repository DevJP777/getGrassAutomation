...
4. Ubah nama file `.env.example` to `.env` lalu masukan id grass anda dengan cara F12>console>ketik localStorage.userId lalu paste di dalam variable userID di file `.env`
